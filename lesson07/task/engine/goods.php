...
<div class="content__goods crumbs__goods">
    <a href="<?= ("../index.php"); ?>">Вернуться на главную</a>
</div>
<div class="content__goods">
    <h2 class="header__goods"><?= $data['title']; ?></h2>
    ...
    <button class="button__goods" <?= ($_SESSION['loginSuccess'] == true && $_SESSION['user']['login']) ? "" : "disabled"; ?>
    onclick="add2cartbig(<?= $data['id']; ?>)">
