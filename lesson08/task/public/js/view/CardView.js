    ...
    getHtml() {
        return `<div class="products__item">
                        ...
                        <div class="products__content">
                            <a href="product.html" class="products__heading">${this._data.title}</a>
                            <p class="products__text">${this._data.description}</p>
                            <p class="products__price">$${parseFloat(this._data.price).toFixed(2)}</p>
                        </div>
                        <span class="products__add" id="card-${parseInt(this._data.id)}">
