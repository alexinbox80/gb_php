export default class CartView {
    ...
    getHtml() {
        return `<div class="cart__item">
                            <img class="cart__item-img" src="img/${this._data.image}" alt="">
                            <div class="cart__text">
                                <h3 class="cart__text-title"><a class="cart__text-link" href="#">${this._data.title}</a></h3>
                                <div class="cart__product-price">Price:&nbsp;<span>$${this._data.price}</span></div>
                                <div class="cart__product-color">Color: ${this._data.color}</div>
