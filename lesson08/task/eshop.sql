...
CREATE TABLE `goods` (
  ...
  `good_id` varchar(36) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
INSERT INTO `goods` (`id`, `good_id`, `title`, `description`, `image`, `color`, `size`, `price`, `discount`) VALUES
(1,	'81245312-a273-0c97-04e8-f99b5b199795',	'NEW ELLERY X MO CAPSULE',	'Known for her sculptural takes on traditional tailoring, Australian<br> arbiter of cool Kym Ellery teams up with Operandi',	'prod-item-1.jpg',	'black',	'L',	45,	15),
(2,	'81207332-a273-0c57-04e8-f99b5b199795',	'NEW ELLERY X MO CAPSULE',	'Known for her sculptural takes on traditional tailoring, Australian<br> arbiter of cool Kym Ellery teams up with Operandi',	'prod-item-2.jpg',	'black',	'XL',	45,	23),
